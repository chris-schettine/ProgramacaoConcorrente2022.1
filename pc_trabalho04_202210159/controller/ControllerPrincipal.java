...
public class ControllerPrincipal implements Initializable {
  ...
  //Semaforos utilizados para resolver as condicoes de corrida
  ...
  public void iniciar(){
    ...
    xilftenOff(); //Deixa visivel apenas a TV em manutencao
  ...
  public void resetaThreads() {
    ...
    for (int y = 0; y < N; y++) {
      escritores[y].interrupt();
      leitores[y].interrupt();
    }
  }
